...
- `-no-correct` - disable the post-transcription vocabulary corrector (`correct/` package; on by default for English, maps misheard spans onto `hints.txt` terms, including `Term: alias1, alias2` spoken-form aliases)
